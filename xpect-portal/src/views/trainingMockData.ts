...
export const TRAINING_TYPES: { label: string; icon: string; cert: string }[] = [
  {
    label: "Level 2 Chemical Handling",
    icon: "science",
    cert: "Chemical Handling Certificate",
  },
  {
    label: "Standard Operating Procedures",
    icon: "menu_book",
    cert: "SOP Compliance Certificate",
  },
  {
    label: "Fire Safety Awareness",
    icon: "local_fire_department",
    cert: "Fire Safety Certificate",
  },
  {
    label: "COSHH Awareness",
    icon: "health_and_safety",
    cert: "COSHH Awareness Certificate",
  },
  {
    label: "Manual Handling Training",
    icon: "engineering",
    cert: "Manual Handling Certificate",
  },
  {
    label: "Health & Safety Induction",
    icon: "verified_user",
    cert: "H&S Induction Certificate",
  },
  {
  ...
  },
  {
    ...
    icon: "altitude",
    cert: "Working at Height Certificate",
  },
  {
    label: "Asbestos Awareness",
    icon: "warning",
    cert: "Asbestos Awareness Certificate",
  },
  {
    label: "Legionella Awareness",
    icon: "water_drop",
    cert: "Legionella Awareness Certificate",
  },
];
