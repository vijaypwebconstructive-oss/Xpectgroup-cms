...
export const api = {
  ...
  cleaners: {
    ...
    getByStatus: async (status: string) => {
      return fetchWithErrorHandling(
        `${API_BASE_URL}/cleaners/status/${status}`,
      );
    },
  ...
  documents: {
    getByCleanerId: async (cleanerId: string) => {
      return fetchWithErrorHandling(
        `${API_BASE_URL}/documents/cleaner/${cleanerId}`,
      );
    },
    ...
    update: async (cleanerId: string, documentId: string, updates: any) => {
      return fetchWithErrorHandling(
        `${API_BASE_URL}/documents/cleaner/${cleanerId}/document/${documentId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  invitations: {
    ...
    getByToken: async (inviteToken: string) => {
      return fetchWithErrorHandling(
        `${API_BASE_URL}/invitations/${inviteToken}`,
      );
    },
    ...
    verifyEmployeeToken: async (token: string, inviteToken: string) => {
      return fetchWithErrorHandling(
        `${API_BASE_URL}/invitations/verify-token`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    resendOtp: async (invitationId: string) => {
      return fetchWithErrorHandling(
        `${API_BASE_URL}/invitations/${invitationId}/resend-otp`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    complete: async (invitationId: string, onboardingProgress?: number) => {
      return fetchWithErrorHandling(
        `${API_BASE_URL}/invitations/${invitationId}/complete`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
    ...
    saveProgress: async (
      ...
      return fetchWithErrorHandling(
        `${API_BASE_URL}/invitations/${inviteToken}/progress`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  activity: {
    ...
    getAll: async (params?: {
      ...
      return fetchWithErrorHandling(
        `${API_BASE_URL}/activity?${query.toString()}`,
      );
    },

    getByEntity: async (entityType: string, entityId: string) => {
      return fetchWithErrorHandling(
        `${API_BASE_URL}/activity/entity/${entityType}/${entityId}`,
      );
    },
  },
  ...
  // Training API
  training: {
    sendExpiryReminder: async (params: {
      email: string;
      cleanerName: string;
      courseName: string;
      expiryDate: string;
      ...
      return fetchWithErrorHandling(
        `${API_BASE_URL}/training/send-expiry-reminder`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
    ...
    checkAndSendExpiryReminders: async (
  ...
  riskCoshh: {
    riskAssessments: {
      getAll: () =>
        fetchWithErrorHandling<
          import("../modules/risk-coshh/types").RiskAssessment[]
        >(`${API_BASE_URL}/risk-coshh/risk-assessments`),
      getById: (id: string) =>
        fetchWithErrorHandling<
          import("../modules/risk-coshh/types").RiskAssessment
        >(`${API_BASE_URL}/risk-coshh/risk-assessments/${id}`),
      create: (
        data: Omit<import("../modules/risk-coshh/types").RiskAssessment, "id">,
      ) =>
        fetchWithErrorHandling<
          import("../modules/risk-coshh/types").RiskAssessment
        >(`${API_BASE_URL}/risk-coshh/risk-assessments`, {
      ...
      update: (
        id: string,
        updates: {
          hazards?: import("../modules/risk-coshh/types").Hazard[];
          requiredPPE?: string[];
          complianceRequirements?: import("../modules/risk-coshh/types").ComplianceRequirement[];
        },
      ) =>
        fetchWithErrorHandling<
          import("../modules/risk-coshh/types").RiskAssessment
      ...
      delete: (id: string) =>
        fetch(`${API_BASE_URL}/risk-coshh/risk-assessments/${id}`, {
          method: "DELETE",
        }).then((r) => {
          if (!r.ok)
            return r
              .json()
              .then((err: { error?: string; message?: string }) => {
                throw new ApiError(
                  r.status,
                  err.message || err.error || "Failed",
                );
              });
        }),
    },
    rams: {
      getAll: () =>
        fetchWithErrorHandling<import("../modules/risk-coshh/types").RAMS[]>(
          `${API_BASE_URL}/risk-coshh/rams`,
        ),
      getById: (id: string) =>
        fetchWithErrorHandling<import("../modules/risk-coshh/types").RAMS>(
          `${API_BASE_URL}/risk-coshh/rams/${id}`,
        ),
      create: (
        data: Omit<import("../modules/risk-coshh/types").RAMS, "id"> & {
          documentData?: string;
        },
      ) =>
        fetchWithErrorHandling<import("../modules/risk-coshh/types").RAMS>(
      ...
      update: (
        id: string,
        updates: { documentData?: string; signedDocumentFileName?: string },
      ) =>
        fetchWithErrorHandling<
          import("../modules/risk-coshh/types").RAMS & { documentData?: string }
        >(`${API_BASE_URL}/risk-coshh/rams/${id}`, {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(updates),
      ...
      delete: (id: string) =>
        fetch(`${API_BASE_URL}/risk-coshh/rams/${id}`, {
          method: "DELETE",
        }).then((r) => {
          if (!r.ok)
            return r
    ...
    chemicals: {
      getAll: () =>
        fetchWithErrorHandling<
          import("../modules/risk-coshh/types").Chemical[]
        >(`${API_BASE_URL}/risk-coshh/chemicals`),
      getById: (id: string) =>
        fetchWithErrorHandling<import("../modules/risk-coshh/types").Chemical>(
          `${API_BASE_URL}/risk-coshh/chemicals/${id}`,
        ),
      create: (
        data: Omit<import("../modules/risk-coshh/types").Chemical, "id">,
      ) =>
        fetchWithErrorHandling<import("../modules/risk-coshh/types").Chemical>(
          `${API_BASE_URL}/risk-coshh/chemicals`,
          {
    ...
    sds: {
      getAll: () =>
        fetchWithErrorHandling<import("../modules/risk-coshh/types").SDS[]>(
          `${API_BASE_URL}/risk-coshh/sds`,
        ),
      getById: (id: string) =>
        fetchWithErrorHandling<
          import("../modules/risk-coshh/types").SDS & { documentData?: string }
        >(`${API_BASE_URL}/risk-coshh/sds/${id}`),
      create: (
        data: Omit<import("../modules/risk-coshh/types").SDS, "id"> & {
          documentData: string;
        },
      ) =>
        fetchWithErrorHandling<import("../modules/risk-coshh/types").SDS>(
  ...
  clientsSites: {
    getClients: () =>
      fetchWithErrorHandling<import("../modules/clients-sites/types").Client[]>(
        `${API_BASE_URL}/clients-sites/clients`,
      ),
    createClient: (
      data: Omit<import("../modules/clients-sites/types").Client, "id">,
    ) =>
      fetchWithErrorHandling<import("../modules/clients-sites/types").Client>(
        `${API_BASE_URL}/clients-sites/clients`,
        {
    ...
    getAssignments: () =>
      fetchWithErrorHandling<
        import("../modules/clients-sites/types").WorkerAssignment[]
      >(`${API_BASE_URL}/clients-sites/assignments`),
    createAssignment: (
      data: Omit<
        import("../modules/clients-sites/types").WorkerAssignment,
        "id"
    ...
    removeAssignment: (workerId: string, siteId: string) =>
      fetchWithErrorHandling<{ success: boolean }>(
        `${API_BASE_URL}/clients-sites/assignments?workerId=${encodeURIComponent(workerId)}&siteId=${encodeURIComponent(siteId)}`,
        {
          method: "DELETE",
        },
      ),
    deleteClient: (id: string) =>
      fetchWithErrorHandling<{ success: boolean }>(
        `${API_BASE_URL}/clients-sites/clients/${id}`,
        { method: "DELETE" },
      ),
  ...
  prospects: {
    getAll: () =>
      fetchWithErrorHandling<import("../modules/prospect/types").Prospect[]>(
    ...
    create: (
      data: Omit<
        import("../modules/prospect/types").Prospect,
        "id" | "createdAt"
      >,
    ) =>
      fetchWithErrorHandling<import("../modules/prospect/types").Prospect>(
    ...
    update: (
      id: string,
      updates: Partial<
        Omit<import("../modules/prospect/types").Prospect, "id" | "createdAt">
      >,
    ) =>
      fetchWithErrorHandling<import("../modules/prospect/types").Prospect>(
        `${API_BASE_URL}/prospects/${id}`,
    ...
    delete: (id: string) =>
      fetch(`${API_BASE_URL}/prospects/${id}`, { method: "DELETE" }).then(
        (r) => {
          if (!r.ok)
            return r
              .json()
  ...
  incidents: {
    ...
    getActions: (id: string) =>
      fetchWithErrorHandling(`${API_BASE_URL}/incidents/${id}/actions`),
    create: (data: any) =>
    ...
    createAction: (incidentId: string, data: any) =>
      fetchWithErrorHandling(
        `${API_BASE_URL}/incidents/${incidentId}/actions`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(data),
    ...
    updateAction: (incidentId: string, actionId: string, updates: any) =>
      fetchWithErrorHandling(
        `${API_BASE_URL}/incidents/${incidentId}/actions/${actionId}`,
        {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(updates),
  ...
  ppe: {
    getInvoices: async () => {
      return fetchWithErrorHandling<import("../types").PPEInvoiceRecord[]>(
        `${API_BASE_URL}/ppe/invoices`,
      );
    },
    createInvoice: async (
      record: Omit<import("../types").PPEInvoiceRecord, "id" | "createdAt">,
    ) => {
      return fetchWithErrorHandling<import("../types").PPEInvoiceRecord>(
        `${API_BASE_URL}/ppe/invoices`,
        {
    ...
    updateInvoice: async (
      id: string,
      updates: Partial<
        Pick<import("../types").PPEInvoiceRecord, "emailStatus">
      >,
    ) => {
      return fetchWithErrorHandling<import("../types").PPEInvoiceRecord>(
        `${API_BASE_URL}/ppe/invoices/${id}`,
        {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(updates),
  ...
  finance: {
    payroll: {
      getAll: (params?: {
        ...
        return fetchWithErrorHandling<
          import("../modules/finance-payroll/types").PayrollRecord[]
        >(`${API_BASE_URL}/finance/payroll${query ? `?${query}` : ""}`);
      },
      getById: (id: string) =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").PayrollRecord
        >(`${API_BASE_URL}/finance/payroll/${id}`),
      create: (record: {
        workerId: string;
        workerName: string;
        month: number;
      ...
      generate: (data: {
        month?: number;
        year?: number;
        workerOverrides?: Record<string, { hoursWorked?: number }>;
      }) =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").PayrollRecord[]
        >(`${API_BASE_URL}/finance/payroll`, {
    ...
    invoices: {
      getAll: (params?: {
        ...
        const query = q.toString();
        return fetchWithErrorHandling<
          import("../modules/finance-payroll/types").Invoice[]
        >(`${API_BASE_URL}/finance/invoices${query ? `?${query}` : ""}`);
      },
      getById: (id: string) =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").Invoice
        >(`${API_BASE_URL}/finance/invoices/${id}`),
      create: (
        data: Omit<import("../modules/finance-payroll/types").Invoice, "id">,
      ) =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").Invoice
        >(`${API_BASE_URL}/finance/invoices`, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(data),
        }),
      update: (
        id: string,
        updates: Partial<import("../modules/finance-payroll/types").Invoice>,
      ) =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").Invoice
        >(`${API_BASE_URL}/finance/invoices/${id}`, {
      ...
      delete: (id: string) =>
        fetchWithErrorHandling<void>(`${API_BASE_URL}/finance/invoices/${id}`, {
          method: "DELETE",
        }),
      send: (id: string) =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").Invoice
        >(`${API_BASE_URL}/finance/invoices/${id}/send`, { method: "POST" }),
    },
    siteContracts: {
      getAll: () =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").SiteContract[]
        >(`${API_BASE_URL}/finance/site-contracts`),
      getById: (id: string) =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").SiteContract
        >(`${API_BASE_URL}/finance/site-contracts/${id}`),
      create: (
        data: Omit<
          import("../modules/finance-payroll/types").SiteContract,
          "id"
    ...
    quotations: {
      getAll: () =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").Quotation[]
        >(`${API_BASE_URL}/finance/quotations`),
      getById: (id: string) =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").Quotation
      ...
      update: (
        id: string,
        updates: Partial<
          Omit<import("../modules/finance-payroll/types").Quotation, "id">
        >,
      ) =>
        fetchWithErrorHandling<
          import("../modules/finance-payroll/types").Quotation
  ...
  performance: {
    getDashboard: (filter: string, offset: number) =>
      fetchWithErrorHandling(
        `${API_BASE_URL}/performance/dashboard?filter=${filter}&offset=${offset}`,
      ),

    // 🔥 GET GOALS
    getGoals: () => fetchWithErrorHandling(`${API_BASE_URL}/performance/goals`),
    ...
    getCharts: (filter: string, offset: number) =>
      fetchWithErrorHandling(
        `${API_BASE_URL}/performance/charts?filter=${filter}&offset=${offset}`,
      ),

    getTransaction: (filter: string, offset: number) =>
      fetchWithErrorHandling(
        `${API_BASE_URL}/performance/transaction?filter=${filter}&offset=${offset}`,
      ),
