...
const FinanceModule: React.FC<Props> = ({ sidebar, handlesidebar }) => {
  ...
  const [isProspectOpen, setIsProspectOpen] = useState(() =>
    ["prospect-list", "prospect-create", "prospect-detail"].includes(
  ...
  const renderContent = () => {
    switch (navState.view) {
      ...
      case "payslip-view":
        return navState.id ? (
          <PayslipViewPage payslipId={navState.id} />
        ) : (
          <PayrollPage />
        );
      case "payslip-create":
      ...
      case "payslip-edit":
        return navState.id ? (
          <PayslipEditPage payslipId={navState.id} />
        ) : (
          <PayrollPage />
        );
      case "payslip":
      ...
      case "invoice-view":
        return navState.id ? (
          <InvoiceViewPage invoiceId={navState.id} />
        ) : (
          <InvoiceListPage />
        );
      case "invoice-create":
      ...
      case "invoice-edit":
        return navState.id ? (
          <InvoiceEditPage invoiceId={navState.id} />
        ) : (
          <InvoiceListPage />
        );
      case "quotation-list":
      ...
      case "quotation-view":
        return navState.id ? (
          <QuotationViewPage quotationId={navState.id} />
        ) : (
          <QuotationListPage />
        );
      ...
      case "quotation-edit":
        return navState.id ? (
          <QuotationEditPage quotationId={navState.id} />
        ) : (
          <QuotationListPage />
        );
