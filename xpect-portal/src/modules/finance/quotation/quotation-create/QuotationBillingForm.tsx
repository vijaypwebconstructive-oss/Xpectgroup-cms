...
const QuotationBillingForm: React.FC<Props> = ({
  ...
  const inputCls =
    "w-full px-3 py-2 bg-[#f6f7fb] border border-[#e7ebf3] rounded-lg text-sm text-[#0d121b] placeholder:text-[#6b7a99] focus:outline-none focus:ring-2 focus:ring-[#2e4150]/20";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h3 className="text-xs font-bold text-[#6b7a99] uppercase tracking-wider mb-3">
            Bill By
          </h3>
          <div className="space-y-3">
            <div>
              <label className="block text-xs font-semibold text-[#6b7a99] mb-1">
                Company Name
              </label>
              <input
                type="text"
                ...
                onChange={(e) =>
                  onBillByChange({ companyName: e.target.value })
                }
                className={inputCls}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onBillByChange({ companyAddress: e.target.value })
                }
                className={inputCls}
                placeholder="Address"
              />
        ...
        <div>
          ...
          <p className="text-xs text-[#6b7a99] mb-2">
            Enter client details manually. No client selection from database.
          </p>
          <div className="space-y-3">
            <div>
              <label className="block text-xs font-semibold text-[#6b7a99] mb-1">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onBillToChange({ clientAddress: e.target.value })
                }
                className={inputCls}
                placeholder="Address"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onBillToChange({ contactPerson: e.target.value })
                }
                className={inputCls}
