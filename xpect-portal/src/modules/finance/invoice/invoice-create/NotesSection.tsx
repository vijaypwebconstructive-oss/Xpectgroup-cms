...
const NotesSection: React.FC<Props> = ({ value, onChange }) => (
  <div className="space-y-4">
    <h2 className="text-sm font-bold text-[#6b7a99] uppercase tracking-wide">Invoice Notes</h2>
    <textarea
      value={value}
      ...
      placeholder="Cleaning services were performed according to the service contract agreement..."
    />
  </div>
);
