...
export enum VerificationStatus {
  ...
  export type AppView = 'DASHBOARD' | 'CLEANERS_LIST' | 'CLEANER_DETAIL' | 'ONBOARDING' | 'ONBOARDING_AUTH' | 'REPORT' | 'THANK_YOU' | 'STAFF_INVITES' | 'EMPLOYEE_COMPLIANCE' | 'TRAINING_CERTIFICATION' | 'TRAINING_DETAIL' | 'PPE_LIST' | 'CLIENTS_SITES' | 'DOCUMENT_CONTROL' | 'RISK_COSHH' | 'INCIDENTS' | 'FINANCE' | 'USER_ACCESS';
