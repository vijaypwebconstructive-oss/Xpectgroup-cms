...
interface PolicyDocumentsContextType {
  ...
  addDocument: (
    data: Omit<PolicyDocument, "id"> & { fileData?: string },
...
const PolicyDocumentsContext = createContext<
  PolicyDocumentsContextType | undefined
>(undefined);
...
export const usePolicyDocuments = () => {
  ...
  if (!ctx)
    throw new Error(
      "usePolicyDocuments must be used within PolicyDocumentsProvider",
    );
  return ctx;
};
...
export const PolicyDocumentsProvider: React.FC<
  PolicyDocumentsProviderProps
> = ({ children }) => {
  ...
  const updateDocument = useCallback(
    async (id: string, updates: Partial<PolicyDocument>) => {
